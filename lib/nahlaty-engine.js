...
function buildHeartExperience(selectedScene=0){
 ...
 const heartImage=i=>`/heart-cinematic/heart-${String(i+1).padStart(2,"0")}.png`;
 const steps=[
 ...
 steps.forEach((step,i)=>{step.image=heartImage(i);step.media={type:"image",src:heartImage(i),role:"cinematic-stage"};});
 return {
  mode:"curated",
